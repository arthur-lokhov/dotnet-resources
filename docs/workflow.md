...
!!! info "Автор использует: Debian"
    ...
    Настройку Debian от автора можно найти [здесь](https://github.com/arthur-lokhov/debian-dev).
...
В `.zshrc` файл можно добавить(в моем конфиге уже есть) следующую строку:
